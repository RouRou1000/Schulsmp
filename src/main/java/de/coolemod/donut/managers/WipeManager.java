 ...
 * Backups werden in plugins/DonutCore/wipes/<UUID>.yml gespeichert.
 */
public class WipeManager {
    ...
    public WipeManager(DonutPlugin plugin) {
        this.plugin = plugin;
    ...
    private void clearPlayerData(UUID uuid) {
        ...
        if (onlinePlayer != null) {
            ...
            onlinePlayer.getInventory().setItemInOffHand(new ItemStack(Material.AIR));
