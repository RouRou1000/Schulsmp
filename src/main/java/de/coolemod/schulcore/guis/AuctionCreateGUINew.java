package de.coolemod.schulcore.guis;

import de.coolemod.schulcore.SchulCorePlugin;
import de.coolemod.schulcore.managers.AuctionHouseManagerNew;
...
public class AuctionCreateGUINew {
    ...
    public AuctionCreateGUINew(SchulCorePlugin plugin, AuctionHouseManagerNew manager) {
        this.plugin = plugin;
