...
public class GUIUtils {
    ...
    public static void fillBorders(Inventory inv, SchulCorePlugin plugin) {
    ...
    public static ItemStack navItem(SchulCorePlugin plugin, Material mat, String name, String action, int page) {
        ItemStack it = new ItemStack(mat);
        ItemMeta m = it.getItemMeta();
        if (m != null) {
