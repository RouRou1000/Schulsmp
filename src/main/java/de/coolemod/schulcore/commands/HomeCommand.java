...
import de.coolemod.schulcore.systems.HomeGUI;
import de.coolemod.schulcore.systems.HomeManager;
...
public class HomeCommand implements CommandExecutor, TabCompleter {
    ...
    public HomeCommand(SchulCorePlugin plugin, HomeManager homeManager) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (subCommand.equals("set") || subCommand.equals("sethome")) {
            if (args.length < 2) {
        ...
        } else if (subCommand.equals("del") || subCommand.equals("delete") || subCommand.equals("remove")) {
            if (args.length < 2) {
                player.sendMessage("§8┃ §6§lHOME §8┃ §7Verwendung: §e/home del <name>");
                return true;
            }
            homeManager.deleteHome(player, args[1]);
        } else if (subCommand.equals("list") || subCommand.equals("gui")) {
            if (homeGUI != null) {
                player.openInventory(homeGUI.createHomesGUI(player));
            } else {
