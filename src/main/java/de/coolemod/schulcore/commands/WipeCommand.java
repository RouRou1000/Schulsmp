...
public class WipeCommand implements CommandExecutor, TabCompleter {
    ...
    public WipeCommand(SchulCorePlugin plugin, WipeManager wipeManager) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (!sender.hasPermission("schulcore.admin")) {
        ...
        if (args.length < 1) {
            if (isWipe) {
                ...
                sender.sendMessage("§8[§6§lWIPE§8] §7Wiped: Inventar, Enderchest, Geld, Shards, Kills/Deaths, Rang, Homes, XP");
            } else {
    ...
    private void handleWipe(CommandSender sender, String targetName) {
        ...
        // Hinweis wenn bereits gewiped (wird überschrieben)
        ...
        if (success) {
            ...
            for (Player p : Bukkit.getOnlinePlayers()) {
                if (p.hasPermission("schulcore.admin")) {
                    p.sendMessage("");
                    p.sendMessage("§c§l━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
            ...
            // Nachricht an den gewipten Spieler
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String alias, String[] args) {
        if (!sender.hasPermission("schulcore.admin")) return Collections.emptyList();
