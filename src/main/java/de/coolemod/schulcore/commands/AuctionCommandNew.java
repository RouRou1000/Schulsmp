...
import de.coolemod.schulcore.guis.AuctionCreateGUI_V2;
...
public class AuctionCommandNew implements CommandExecutor {
    ...
    public AuctionCommandNew(SchulCorePlugin plugin, AuctionGUINew auctionGUI, AuctionCreateGUI_V2 createGUI) {
        this.plugin = plugin;
